# Generated by Django 4.2.11 on 2024-03-11 12:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='events/images/', verbose_name='Фотография мероприятия')),
                ('date', models.DateField(verbose_name='Дата проведения мероприятия')),
                ('organizations', models.ManyToManyField(to='community.organisation', verbose_name='Организаторы мероприятия')),
            ],
            options={
